...
public class SysUserControllerTest extends BaseControllerTest {
    ...
    public void addManager() throws Exception {
        String url = "/sys/user/add";

        Map params = new HashMap();
        params.put("userName", "13819493703");
    ...
    public void getManager() throws Exception {
        ...
        assertEquals("13819493702", sysUser.getUserName());
    }

    @Test
    public void getManagersByRoleId() throws Exception {
        String url = "/sys/user/userrole";
